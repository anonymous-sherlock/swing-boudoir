  ...
  const faqs = [
    {
      ...
      answer: "All models aged 18 and above can participate in our competitions. You must be legally able to enter contracts and travel internationally if you win. No prior modeling experience is required."
    },
    {
      id: "entry-fee",
    ...
    },
    {
      ...
      answer: "Typically, you'll need to submit 3-5 high-quality photos showcasing different looks and styles, a brief bio, and complete the registration form. Specific requirements may vary by competition."
    },
    {
      id: "judging-process",
      question: "How are winners selected?",
      answer: "Our panel of industry professionals evaluates entries based on photogenic quality, personality, marketability, and alignment with the competition theme. Public voting may also be a component."
    },
    {
        ...
        <section className="py-20 bg-gradient-hero">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-white/90 max-w-2xl mx-auto">
              Find answers to the most common questions about Maxim Covergirl competitions
            </p>
          </div>
        </section>
              ...
              <Accordion type="single" collapsible className="space-y-4">
                {faqs.map((faq) => (
                  <AccordionItem
                    key={faq.id}
                    value={faq.id}
                    className="border border-border rounded-lg px-6 shadow-card hover:shadow-luxury transition-luxury"
                  >
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-12">
              <Button className="bg-gradient-competition text-competition-foreground hover:opacity-90 transition-smooth">
                Contact Support
              </Button>
            </div>
          </div>
