...
import { prizeTerms, prohibitedActions, ruleCategories } from "@/constants/rules.constants";
    ...
    <main className="pt-16 pb-16">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">Prohibited Actions</h2>
              <p className="text-lg text-muted-foreground">The following actions will result in immediate disqualification</p>
            </div>
            ...
            <Card className="shadow-card border-destructive/20">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="font-semibold text-destructive text-xl">Actions That Lead to Disqualification</h3>
                </div>
                <ul className="space-y-3">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">Prize Terms & Conditions</h2>
              <p className="text-lg text-muted-foreground">Important information about claiming and receiving prizes</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-muted-foreground space-y-4 text-sm leading-relaxed">
              ...
              <p>
                These competitions are void where prohibited by law. Participants must comply with all local, state, and federal laws. For complete legal terms, please review our
                Terms of Service and Privacy Policy.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <a href="/terms" className="inline-flex items-center justify-center px-6 py-2 border border-border rounded-lg font-medium hover:bg-muted/50 transition-smooth">
                Terms of Service
              </a>
              <a href="/privacy" className="inline-flex items-center justify-center px-6 py-2 border border-border rounded-lg font-medium hover:bg-muted/50 transition-smooth">
                Privacy Policy
              </a>
            </div>
          </div>
