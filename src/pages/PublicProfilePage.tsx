...
export default function PublicProfilePage() {
    ...
    const loadProfile = async () => {
      if (id) {
        try {
          ...
          const profile = await getModelProfileByUsername(id);
  ...
  const canVote = () => {
    if (!lastVoteTime || !id) return true;
    const now = new Date();
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case "ended":
        return <Badge variant="secondary" className="text-xs px-2 py-1">Ended</Badge>;
      case "coming-soon":
        return <Badge variant="outline" className="text-xs px-2 py-1 border-blue-200 text-blue-600">Upcoming</Badge>;
      default:
    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button 
              onClick={() => setShowPaidVoteOptions(true)}
              variant="outline" 
              size="sm"
              className="text-gray-600 hover:text-gray-800 border-gray-300 hidden sm:flex"
            >
              <DollarSign className="w-4 h-4 mr-1" />
              Buy More Votes
            </Button>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pt-16">
        ...
        <div className="relative w-full h-48 md:h-64 bg-gradient-to-r from-blue-400 to-purple-500 overflow-hidden">
          {modelProfile.coverImage?.url ? (
            <img
              src={modelProfile.coverImage.url}
              alt="Profile Banner"
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="mb-24">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-600">See what {id} is competing in right now</p>
            </div>
                        ...
                        <div className="lg:w-3/5 p-4">
                          <div className="flex items-start justify-between mb-3">
                            <h3 className="text-lg font-bold text-gray-900">
                              {registration.contest?.name || 'Contest'}
                            </h3>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <div>
                                ...
                                <div className="font-semibold text-sm">
                                  {registration.contest?.endDate ? formatDate(registration.contest.endDate) : '-'}
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-lg p-3">
                              <div className="text-center">
                                ...
                                <div className="text-lg font-bold text-orange-600">
                                  {timeLeft[registration.contestId]}
                                </div>
                              </div>
                            </div>
                          )}
              ...
              <Card className="shadow-sm">
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4 max-w-md mx-auto text-sm">
                    {id} hasn't joined any competitions yet. Check back soon for exciting opportunities!
                  </p>
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 inline-block">
                    <p className="text-sm text-gray-500">
                      <strong>Tip:</strong> Competitions will appear here once {id} joins them.
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                >
                  ...
                  {canVote() ? `Vote for ${id}` : 'Buy More Votes'}
                </Button>
        ...
        {showPaidVoteOptions && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 relative">
              <button
                onClick={() => setShowPaidVoteOptions(false)}
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Choose a package to support {id} with more votes</p>
              </div>
