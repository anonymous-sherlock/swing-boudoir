    ...
    <div className="py-12">
      ...
      <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
        {photos.map((photo, index) => {
          const optimizedImageUrl = getImageUrl(photo.url, 'gallery');
          return (
            <Card
              key={photo.id}
            ...
            >
              <div className="relative overflow-hidden rounded-lg">
                <img src={optimizedImageUrl} alt={photo?.caption ?? ""} className="w-full h-auto object-cover" loading={index < 6 ? "eager" : "lazy"} />
