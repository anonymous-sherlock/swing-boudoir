...
const BannerSelectorLazy = React.lazy(() => import("./BannerSelectModal").then((module) => ({ default: module.default })));
...
const PortfolioScene: React.FC<PortfolioSceneProps> = ({ formData, updateFormData, onNext }) => {
  ...
  const getObjectUrl = useCallback((file: File | null): string => {
  ...
  return (
    <div className="relative">
                  ...
                  <div className="relative mb-20">
                    ...
                    >
                      ...
                      {formData.bannerImage ? (
                        <>
                          {getObjectUrl(formData.bannerImage) && (
                    ...
                    <div className="absolute -bottom-0 left-8">
                      ...
                      >
                        ...
                        {formData.profileAvatar ? (
                          <>
                            {getObjectUrl(formData.profileAvatar) && (
                    ...
                    <div className="photo-preview">
                      {formData.photos.map((file, index) => (
                        <div key={`${file.name}-${index}`} className="photo-item">
                          {getObjectUrl(file) && <img src={getObjectUrl(file)} alt={`Portfolio ${index + 1}`} loading="lazy" decoding="async" />}
      ...
      <BannerSelectorLazy
        ...
        onOpenChange={setShowBannerLibrary}
        bannerImage={formData.bannerImage}
        onBannerSelect={(file) => updateFormData({ bannerImage: file })}
