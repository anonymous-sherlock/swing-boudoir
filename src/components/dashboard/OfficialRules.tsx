        ...
        <CardContent className="space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              These Official Rules govern the Swing Boudoir Ultimate Cover Model Competition ("Competition"). By entering, you agree to be bound by these rules and the decisions of
              the judges, which are final and binding.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-2">
              ...
              <p>
                <strong>Entry is 100% FREE.</strong> No purchase necessary to enter or win.
              </p>
            </div>
          </section>

          <section>
            <h3 className="text-lg font-semibold mb-3">3. Voting Process & Rankings</h3>
            <div className="text-muted-foreground space-y-2">
              <p>
                <strong>Free Voting:</strong>
              </p>
              <ul className="list-disc list-inside space-y-1">
              ...
              <p>
                <strong>Premium Voting (Optional):</strong>
              </p>
              <ul className="list-disc list-inside space-y-1">
              ...
              <p>
                <strong>Rankings:</strong> Real-time leaderboard updates may be shared throughout the competition period. Final rankings determined by total vote count at
                competition close.
              </p>
            </div>
          </section>
          ...
          <section>
            <h3 className="text-lg font-semibold mb-3">4. Prizes & Awards</h3>
            <div className="text-muted-foreground space-y-2">
              <p>
                <strong>🥇 1st Place Winner (Most Votes Overall):</strong>
              </p>
              <ul className="list-disc list-inside space-y-1">
                <li>$$$ cash prize (subject to applicable taxes)</li>
              ...
              <p>
                <strong>Prize Conditions:</strong> Winners must claim prizes within 30 days. Cash prizes subject to tax reporting requirements. Non-cash prizes have no monetary
          ...
          <section>
            <h3 className="text-lg font-semibold mb-3">5. Contestant Responsibilities</h3>
            <div className="text-muted-foreground space-y-2">
              <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h3 className="text-lg font-semibold mb-3">6. Prohibited Conduct & Disqualification</h3>
            <div className="text-muted-foreground space-y-2">
          ...
          <section>
            <h3 className="text-lg font-semibold mb-3">7. Intellectual Property & Media Rights</h3>
            <div className="text-muted-foreground space-y-2">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Swing Boudoir Magazine and its affiliates are not responsible for technical failures, lost or delayed entries, voting irregularities beyond our control, or any
              damages arising from participation in this competition. Contestants participate at their own risk.
            </p>
          </section>

          <section>
            <h3 className="text-lg font-semibold mb-3">9. Modifications & Cancellation</h3>
            <p className="text-muted-foreground">
              Swing Boudoir reserves the right to modify these rules, extend deadlines, or cancel the competition if circumstances warrant such action. Participants will be
              notified of any material changes via email and social media announcements.
            </p>
          </section>

          <section>
            <h3 className="text-lg font-semibold mb-3">10. Governing Law & Disputes</h3>
            <p className="text-muted-foreground">
              These Official Rules are governed by the laws of [State/Country]. Any disputes arising from this competition shall be resolved through binding arbitration. Winners
              may be required to sign additional legal documents before receiving prizes.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="text-muted-foreground">
              ...
              <p>
                <strong>Phone:</strong> +44 7878619356
              </p>
              <p>
